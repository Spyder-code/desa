        ...
        <div class="row">
            <div class="col-sm-6 mt-3">
                <div class="card border border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Agama</div>
                    <div class="card-body">
                ...
                <div class="card border mt-3 border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Dusun</div>
                    <div class="card-body">
                        <div class="table-responsive">
                ...
                <div class="card border mt-3 border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Pekerjaan</div>
                    <div class="card-body">
                        <div class="table-responsive">
            ...
            <div class="col-sm-6 mt-3">
                <div class="card border border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Pendidikan</div>
                    <div class="card-body">
                        <div class="table-responsive">
                ...
                <div class="card border mt-3 border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Perkawinan</div>
                    <div class="card-body">
                        <div class="table-responsive">
                ...
                <div class="card border mt-3 border-dark">
                    <div class="card-header" style="background: rgba(255, 255, 77, 0.5);">Umur</div>
                    <div class="card-body">
                        <div class="table-responsive">
