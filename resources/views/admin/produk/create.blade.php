                    ...
                    <div class="card-body">
                        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-5">
                                    <label>Harga</label>
                                    <input type="number" min="1" name="harga" class="uang form-control @error('harga') is-invalid @enderror" value="{{ old('harga') }}">
                                    @error('harga')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <button type="submit" class="btn btn-success mt-2 d-block w-100">Buat Produk</button>
                        </form>
                    </div>
                </div>
            </div>
